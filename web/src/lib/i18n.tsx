...
const en: Dict = {
  ...
  'detail.title': 'CELL',
  'help.open': 'Help',
  'ai.hint': 'query · analyze · join · scan catalog',
  'ai.scope': 'DATABASES',
  ...
  'ai.saveKey': 'save key',
  'ai.noKey': 'no key',
  'ai.empty': 'Pick databases, then generate a query, analyze SQL, suggest joins, or scan the catalog.',
  'ai.you': 'YOU',
  'ai.placeholder': 'e.g. monthly sales by branch, join customers to orders',
  'ai.scanPlaceholder': 'optional focus, e.g. reporting tables',
  'ai.pasteSql': 'Paste SQL to analyze',
  'ai.send': 'ask',
  'ai.scan': 'scan',
  'ai.working': 'thinking…',
  'ai.objects': 'objects',
  'ai.scanDefault': 'Scan each selected database and propose useful queries and joins.',
  'ai.scanStart': 'Scan selected databases one by one.',
  'ai.mode.query': 'query',
...
const id: Dict = {
  ...
  'help.open': 'Bantuan',
  'nav.ai': 'AI',
  'ai.hint': 'query · analisa · join · scan katalog',
  'ai.scope': 'DATABASE',
  ...
  'ai.empty': 'Pilih database, lalu buat query, analisa SQL, usulkan join, atau scan katalog.',
  'ai.you': 'ANDA',
  'ai.placeholder': 'mis. penjualan bulanan per cabang, join customer ke order',
  'ai.scanPlaceholder': 'fokus opsional, mis. tabel laporan',
  'ai.pasteSql': 'Tempel SQL untuk dianalisa',
  'ai.send': 'tanya',
  'ai.scan': 'scan',
  'ai.working': 'berpikir…',
  'ai.objects': 'objek',
  'ai.scanDefault': 'Scan setiap database terpilih dan usulkan query serta join yang berguna.',
  'ai.scanStart': 'Scan database terpilih satu per satu.',
  'ai.mode.query': 'query',
