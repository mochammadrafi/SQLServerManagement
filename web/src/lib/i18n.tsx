...
const en: Dict = {
  ...
  'ai.saveKey': 'save key',
  'ai.noKey': 'no key',
  'ai.empty': 'Pick databases, preview context on the right, then ask for a query or join.',
  'ai.you': 'YOU',
  ...
  'ai.preview': 'Preview',
  'ai.mentionHint': 'Type @ to pick database, table, or column from preview context.',
  ...
  'ai.noContext': 'Ask something to load catalog context and steps here.',
...
const id: Dict = {
  ...
  'ai.empty': 'Pilih database, lihat preview konteks di kanan, lalu tanya query atau join.',
  'ai.you': 'ANDA',
  ...
  'ai.preview': 'Preview',
  'ai.mentionHint': 'Ketik @ untuk pilih database, tabel, atau kolom dari konteks preview.',
  'ai.level.db': 'DATABASE',
  ...
  'ai.noContext': 'Tanya sesuatu untuk memuat konteks katalog dan langkah proses di sini.',
